...
<?php if($PageMax > 1): ?><ul data-am-widget="pagination" class="am-pagination am-pagination-select">
        <li class="am-pagination-prev ">
            <?php if(1 != $Page ): ?><a href="/index.php?s=/Home/Index/index/p/<?php echo ($Page-1); ?>#money-table" class="">上一页</a> 
            <?php else: ?> <a href="/index.php?s=/Home/Index/index/p/<?php echo ($Page); ?>#money-table" class="">上一页</a><?php endif; ?>
        </li>
        
        <li class="am-pagination-select">
            <select id="pid" onchange="SelectChange()" style="-webkit-appearance: button;">
                <?php $__FOR_START_1895326961__=1;$__FOR_END_1895326961__=$PageMax + 1;for($i=$__FOR_START_1895326961__;$i < $__FOR_END_1895326961__;$i+=1){ if($i == $Page ): ?><option value="/index.php?s=/Home/Index/index/p/<?php echo ($i); ?>#money-table" selected="selected">&nbsp;<?php echo ($i); ?></option>
                    <?php else: ?> 
                        <option value="/index.php?s=/Home/Index/index/p/<?php echo ($i); ?>#money-table" class="">&nbsp;<?php echo ($i); ?></option><?php endif; } ?>
            </select>
        </li>
        
        
        <li class="am-pagination-next ">
            <?php if($PageMax != $Page ): ?><a href="/index.php?s=/Home/Index/index/p/<?php echo ($Page+1); ?>#money-table" class="">下一页</a>
            <?php else: ?> <a href="/index.php?s=/Home/Index/index/p/<?php echo ($Page); ?>#money-table" class="">下一页</a><?php endif; ?>
        </li>
    </ul>
