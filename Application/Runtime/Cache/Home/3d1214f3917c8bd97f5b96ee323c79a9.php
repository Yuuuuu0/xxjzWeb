  ...
  <header data-am-widget="header" style="background-color:#19a7f0"
    ...
    <div data-am-widget="tabs" class="am-tabs am-tabs-secondary" id="doc-form-tabs" >
        <ul class="am-tabs-nav am-cf">
            ...
            <?php if(count($FundsData) > 1): ?><li class=""><a href="/index.php?s=/Home/Add/transfer">转账</a></li><?php endif; ?>
        </ul>
        <div class="am-tabs-bd">
            ...
            <?php else: ?>
                ...
                <form class="am-form am-form-horizontal" enctype="multipart/form-data" method="post" data-am-validator="H5validation:false">
                    ...
                    <div class="am-input-group">
                        ...
                        <input type="date" class="am-form-field" id="text-time" name="add_time" value="<?php echo date('Y-m-d',time()); ?>" />
                    </div>
            ...
            <?php else: ?>
                ...
                <form class="am-form am-form-horizontal" enctype="multipart/form-data" method="post" data-am-validator="H5validation:false">
                    ...
                    <div class="am-input-group">
                        <span class="am-input-group-label"><b>备注</b></span>
                        <input type="text" class="am-form-field" id="text-mark" name="add_mark" placeholder="输入收入信息">
                        <span class="am-input-group-btn am-form-file">
                            <button type="button" class="am-btn am-btn-default"><i class="am-icon-cloud-upload"></i> 上传图片</button>
...
<?php if($PageMax > 1): ?><ul data-am-widget="pagination" class="am-pagination am-pagination-select">
        <li class="am-pagination-prev ">
            <?php if(1 != $Page ): ?><a href="/index.php?s=/Home/Add/index/p/<?php echo ($Page-1); ?>#money-table" class="">上一页</a> 
            <?php else: ?> <a href="/index.php?s=/Home/Add/index/p/<?php echo ($Page); ?>#money-table" class="">上一页</a><?php endif; ?>
        </li>
        
        <li class="am-pagination-select">
            <select id="pid" onchange="SelectChange()" style="-webkit-appearance: button;">
                <?php $__FOR_START_1639884616__=1;$__FOR_END_1639884616__=$PageMax + 1;for($i=$__FOR_START_1639884616__;$i < $__FOR_END_1639884616__;$i+=1){ if($i == $Page ): ?><option value="/index.php?s=/Home/Add/index/p/<?php echo ($i); ?>#money-table" selected="selected">&nbsp;<?php echo ($i); ?></option>
                    <?php else: ?> 
                        <option value="/index.php?s=/Home/Add/index/p/<?php echo ($i); ?>#money-table" class="">&nbsp;<?php echo ($i); ?></option><?php endif; } ?>
            </select>
        </li>
        
        
        <li class="am-pagination-next ">
            <?php if($PageMax != $Page ): ?><a href="/index.php?s=/Home/Add/index/p/<?php echo ($Page+1); ?>#money-table" class="">下一页</a>
            <?php else: ?> <a href="/index.php?s=/Home/Add/index/p/<?php echo ($Page); ?>#money-table" class="">下一页</a><?php endif; ?>
        </li>
    </ul>
...
$(function(){
    ...
    <script>
      ...
      $(function() {
        // 页面加载时自动切换到收入标签
        $('.am-tabs-nav li a:contains("收入")').click();
